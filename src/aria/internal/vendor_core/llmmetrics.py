...
defaults to ``aria.internal.vendor_core.pricing.calculate_cost``. Used by llm-cost-latency-monitor,
ARIA-compatible services, and github-issue-pr-agent.
"""
...
class LLMMetrics:
    ...
    def record(
        ...
        *,
        ...
        """Record one call; cost defaults to ``aria.internal.vendor_core.pricing`` if not provided."""
        cost = (
            cost_usd
